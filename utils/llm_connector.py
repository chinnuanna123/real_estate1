...
class LLMConnector:
    ...
    async def call_llm_api(
        ...
        # --- OpenAI Handling ---
            ...
            if response_schema:
                if not any("json" in msg["content"].lower() for msg in openai_messages):
                    openai_messages.insert(
                        0,
                        {
                            "role": "user",
                            "content": "Please respond in strict JSON format.",
                        },
                    )
            ...
            try:
                completion = await asyncio.to_thread(
                    ...
                    response_format="json" if response_schema else None,
                )
                ...
                if response_schema:
                    try:
                        ...
                        print(f"⚠️ Malformed JSON from OpenAI: {text_response}")
                        return text_response
